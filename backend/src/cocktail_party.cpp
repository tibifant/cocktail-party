...
static const char *SingleInstructions[] = { "Cool to absolute Zero.", "Mix with Ice III.", "Bake for 20 minutes.", "Bring to a boil.", "Reduce to half.", "Deglaze the pan.", "Add a pinch of Salt.", "Shake the mixture.", "Let it sit for 1 hour.", "Cool down to room temperature.", "Refrigerate over night.", "Precool the glass." };
